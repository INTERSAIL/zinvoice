...
class SupportsControllerTest < ActionController::TestCase
  ...
  test "should create support" do
    assert_difference('Support.count') do
      post :create, support: { ammount: @support.ammount, customer_id: @support.customer_id, desc: @support.desc, from: @support.from, note: @support.note, status: @support.status, to: @support.to }
    end
  ...
  test "should update support" do
    patch :update, id: @support, support: { ammount: @support.ammount, customer_id: @support.customer_id, desc: @support.desc, from: @support.from, note: @support.note, status: @support.status, to: @support.to }
    assert_redirected_to support_path(assigns(:support))
  end
